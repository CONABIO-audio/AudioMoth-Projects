...
#define AM_USB_MSG_TYPE_SEND_DATA_PACKET          0x09
...
void AudioMoth_sendUSBPacket(int16_t value) {
    ...
    transmitBuffer[0] = AM_USB_MSG_TYPE_SEND_DATA_PACKET;

    /* Write value to buffer */

    memcpy(transmitBuffer, value, sizeof(uint16_t));
...
void AudioMoth_startUSBCommunication(void) {
    /* Configure data input pin */
...
void AudioMoth_endUSBCommuncation(void) {
